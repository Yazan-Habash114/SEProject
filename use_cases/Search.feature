Feature: Search about suitable home
  ...
  Scenario: Allowing pets
    ...
    Then A list of homes that are Allowing pets "NO" should be returned and printed on the console
    And send an email with the list of found homes to "yazanalhabash5@gmail.com" 
  
  @Scenario15
	Scenario: Mixing more than one feature
		When I search about home by Placement "VILLAGE" 
		And I search about home by Number of bathrooms 1
		And I search about home by Material "WOOD" 
		And I search about home by Type "APARTMENT" 
		Then A list of homes that provide the Palcement "VILLAGE" , match the the number of bathrooms 1 , have material "WOOD" and type "APARTMENT" should be returned and printed on the console
		And send an email with the list of found homes to "yazanalhabash5@gmail.com" 
